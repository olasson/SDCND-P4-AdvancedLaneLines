...
* [`_centroids.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/_centroids.py)
* [`_draw.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/_draw.py)
* [`_error.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/_error.py)
* [`_math.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/_math.py)
* [`_process.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/_process.py)
* [`calibration.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/calibration.py)
* [`detect.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/detect.py)
* [`io.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/io.py)
* [`misc.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/misc.py)
* [`plots.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/code/plots.py)

All files starting with `_` are supporting files for `detect.py` which contains the pipeline implementation. 

The main project script is called [`advanced_lane_lines.py`](https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/advanced_lane_lines.py). It contains the implementation of a very simple command line tool.
...
<p align="center">
  <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/calibration_debug.png">
</p>
...
<p align="center">
  <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/test/straight_lines1.jpg">
</p>

And here is the same image after undistortion:

<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step01_image_undistorted.png">
</p>
...
<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step02_gradient_binary.png">
</p>
...
<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step03_color_binary.png">
</p>

In the pipeline, the gradient binary and the color binary is combined to produce the final thresholded image:

<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step05_combined_threshold.png">
</p>
...
<p align="center">
    <img width="40%" height="40%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step06_src.png">
    <img width="40%" height="40%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step07_dst.png">
</p>
...
<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/images/result/straight_lines1/step08_lane_image.png">
</p>
...
<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/videos/result/project_video.gif">
</p>

### Challenge video

<p align="center">
    <img width="80%" height="80%" src="https://github.com/olasson/SDCND-P4-AdvancedLaneLines/blob/master/videos/result/challenge_video.gif">
</p>
